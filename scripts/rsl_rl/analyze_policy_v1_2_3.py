"""Offline rollout diagnostics for Berkeley Humanoid Lite v1.2.3 policies.

This script is intentionally analysis-only. It loads a checkpoint, rolls out the selected
v1.2.3 task, and writes JSON/CSV summaries for raw policy output, bounded action use,
...
Example:
    python scripts/rsl_rl/analyze_policy_v1_2.py \
        ...
        --load_run 2026-07-10_12-00-00_stand_seed42 \
...
parser = argparse.ArgumentParser(description="Analyze a v1.2.3 Berkeley Humanoid Lite policy rollout.")
