"""Offline rollout diagnostics for Berkeley Humanoid Lite v1.4.4 move-now loaded-ST3215 policies.

This script is intentionally analysis-only. It loads a checkpoint, rolls out the selected
v1.4.4 move-now loaded-ST3215 task, and writes JSON/CSV summaries for raw policy output, bounded action use,
...
parser = argparse.ArgumentParser(description="Analyze a v1.4.4 move-now loaded-ST3215 Berkeley Humanoid Lite policy rollout.")
