"""Offline rollout diagnostics for Littlegreen Humanoid Lite v9 phase-guided loaded-ST3215 policies.

This script is intentionally analysis-only. It loads a checkpoint, rolls out the selected
v9 gait-acquisition loaded-ST3215 task, and writes JSON/CSV summaries for raw policy output, bounded action use,
...
parser = argparse.ArgumentParser(description="Analyze a v9 gait-acquisition loaded-ST3215 Littlegreen Humanoid Lite policy rollout.")
